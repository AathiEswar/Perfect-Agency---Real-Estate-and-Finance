...
const Footer: React.FC = () => {
  ...
  return (
    <footer id="contact" className="w-full bg-saisei-beige text-saisei-dark pt-16 md:pt-20 lg:pt-24 pb-8 md:pb-12 px-6 md:px-12 lg:px-16">
      ...
      <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16 md:mb-20 lg:mb-24 border-b border-saisei-dark/20 pb-16 md:pb-20 lg:pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 lg:gap-12 w-full">
          ...
          >
            <h4 className="text-xs tracking-[0.2em] uppercase opacity-80 mb-3 md:mb-4">{footer.contact.phone.label}</h4>
          ...
          >
            <h4 className="text-xs tracking-[0.2em] uppercase opacity-80 mb-3 md:mb-4">{footer.contact.email.label}</h4>
          ...
          >
            <h4 className="text-xs tracking-[0.2em] uppercase opacity-80 mb-3 md:mb-4">{footer.contact.whatsapp.label}</h4>
            <a href={footer.contact.whatsapp.link} target="_blank" rel="noopener noreferrer" className="text-lg md:text-xl lg:text-2xl font-serif hover:text-saisei-brown transition-colors">
              {footer.contact.whatsapp.value}
            </a>
          </motion.div>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs opacity-70">
        ...
        <div className="flex gap-4 md:gap-6">
          {footer.links && footer.links.length > 0 && footer.links.map((link: any, index: number) => (
